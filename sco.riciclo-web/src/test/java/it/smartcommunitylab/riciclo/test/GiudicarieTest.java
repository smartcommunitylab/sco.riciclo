...
import it.smartcommunitylab.riciclo.app.giudicarie.controller.GiudicarieController;
...
public class GiudicarieTest {
	...
	private static final String EXCEL_MODELLO_CONCETTUALE_XLS = "giudicarie/ExcelModelloConcettuale_V0.27.xls";
	...
	public void testUpload() throws Exception {
		GiudicarieController controller = wac.getBean(GiudicarieController.class);
